...
```bash
python3 .codex/skills/ui-ux-pro-max/scripts/search.py "<product type> <industry> <tone>" --design-system -f markdown -p "<Project Name>"
```

3. For targeted decisions, search the bundled data:

```bash
python3 .codex/skills/ui-ux-pro-max/scripts/search.py "minimal dashboard" --domain style
python3 .codex/skills/ui-ux-pro-max/scripts/search.py "healthcare dashboard" --domain color
python3 .codex/skills/ui-ux-pro-max/scripts/search.py "professional data table" --domain ux
python3 .codex/skills/ui-ux-pro-max/scripts/search.py "trend comparison" --domain chart
...
```bash
python3 .codex/skills/ui-ux-pro-max/scripts/search.py "<query>" --design-system --persist -f markdown -p "<Project Name>" --output-dir .
```
